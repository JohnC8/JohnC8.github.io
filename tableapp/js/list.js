...
function GetBooking() {
    let url = 'https://api.sheety.co/14b8f45507a042cf35d5be48ef8d40c9/bookingApp/bookings';
    fetch(url)
...
function DeleteBooking(id) {
    let url = 'https://api.sheety.co/14b8f45507a042cf35d5be48ef8d40c9/bookingApp/bookings/' + id;
    fetch(url, {
        method: 'DELETE',
    })
        .then(() => {
